...
function App() {
  ...
  return (
    <AppContext.Provider value={{LoginSuccess, OnClickLoginButton, SetSuccess, ChangeBgProfile, open, setOpen, LoginValue, SetLoginValue, PassValue, SetPassValue, OnCangeLoginInput, OnCangePassInput}}>
